package com.sd.sdzx.pay.service.impl;

import com.alibaba.fastjson.JSON;
import com.sd.sdzx.feign.order.OrderFeignClient;
...
import com.sd.sdzx.pay.mapper.PaymentInfoMapper;
import com.sd.sdzx.pay.service.PaymentInfoService;
...
public class PaymentInfoServiceImpl implements PaymentInfoService {
    ...
    public void updatePaymentStatus(Map<String, String> map, Integer payType) {
        ...
        Result<OrderInfo> orderInfo = orderFeignClient.getOrderInfoByOrderNo(paymentInfo.getOrderNo());

        //可改为rabbitmq
        List<SkuSaleDto> skuSaleDtoList = orderInfo.getData().getOrderItemList().stream().map(item -> {
